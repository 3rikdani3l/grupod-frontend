...
public class ProductoQuery_QV_RA41_SVS85 implements IGridRowUpdating {
	/**
	 * Instancia de Logger
	 */
	private static final ILogger logger = LogFactory.getLogger(ProductoQuery_QV_RA41_SVS85.class);

	@Reference(bind = "setBLIActualizarProducto", unbind = "unsetBLIActualizarProducto", cardinality = ReferenceCardinality.MANDATORY_UNARY, target = "(bli.id=BLI1083_bli_actualizarproducto)")
